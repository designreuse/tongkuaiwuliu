...
<div class="main-container" id="main-container">
  ...
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">货物基本信息</h3>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/logistics/cargo.js"></script>
