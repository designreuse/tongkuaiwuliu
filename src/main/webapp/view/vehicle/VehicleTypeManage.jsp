...
<div class="main-container" id="main-container">
    ...
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue">车型基本信息</h3>
        ...
        <div id="base-info" class="tab-pane active dataTables_wrapper form-inline" role="grid">
            ...
            <table id="sample-table" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info" >
                ...
                <tr class="odd" style="display:none;">
                    ...
                    <td class="capacity"><input type="text"></td>
                    <td class="description"><input type="text"></td>
                    <td class="height"><input type="text"></td>
                    <td class="length"><input type="text"></td>
                    <td class="oilType"><input type="text"></td>
                    <td class="seat"><input type="text"></td>
                    <td class="width"><input type="text"></td>
                    <td class="op">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/vehicle/vehicleType.js"></script>
