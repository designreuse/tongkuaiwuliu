...
<div class="main-container" id="main-container">
    ...
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue">车辆基本信息</h3>
        ...
        <div id="base-info" class="tab-pane active dataTables_wrapper form-inline" role="grid">
            ...
            <table id="sample-table" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info" >
                ...
                <tr class="odd" style="display:none;">
                    ...
                    <td class="driverId" style="display: none;"></td>
                    <td class="vehicleTypeId" style="display: none;"></td>
                    <td class="carNumber"><input type="text"></td>
                    <td class="color"><input type="text"></td>
                    <td class="identity"><input type="text"></td>
                    <td class="driver"><select class="driverSelect"></select></td>
                    <td class="vehicleType"><select class="vehicleTypeSelect"></select></td>
...
<script type="text/javascript" charset="utf-8" src="<%=request.getContextPath()%>/js/vehicle/vehicle.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/vehicle/vehicleManage.js"></script>
</body>
