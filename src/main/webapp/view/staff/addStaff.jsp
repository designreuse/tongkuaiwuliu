...
<div class="main-container" id="main-container">
    ...
    <div class="nav-list">
        <nav>
            <ul class="pager">
                <li class="previous"><a href="<%=request.getContextPath()%>/view/staff/staff.jsp"><span
    ...
    <div class="addForm form-horizontal" role="form">
      ...
      <span class="profile-picture">
                <img id="avatar" class="editable img-responsive editable-click editable-empty" width="150px"
                     height="150px" src="${user.image_url}"/>
                <form name="userForm" id="imgForm" action="<%=request.getContextPath()%>/image/upload" method="post"
                      enctype="multipart/form-data" class="form-inline editableform">
    ...
    <div class="btnArea">
        <button id="saveAdd" class="btn btn-primary">确认</button>
        <%--<button id="cancal" class="btn btn-danger">取消</button>--%>
...
<script src="<%=request.getContextPath()%>/js/staff/addStaff.js"></script>
</body>
