...
<div class="main-container" id="main-container">
  ...
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">运输地址信息</h3>
    ...
    <div id="base-info" class="tab-pane active dataTables_wrapper form-inline" role="grid">
      ...
      <table id="sample-table" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info" >
        ...
        <tr class="odd" style="display:none;">
          ...
          <td class="levelValue" style="display: none"></td>
          <td class="parentValue" style="display: none"></td>
          <td class="areaName"><input type="text"></td>
          <td class="pinyin"><input type="text"></td>
          <td class="level">
            <select id="selectLevel" class="selectLevel">
              <option value="1" selected="selected">省（自治区、直辖市）</option>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/address/addressManage.js"></script>
