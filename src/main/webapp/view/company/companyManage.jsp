...
<div class="main-container" id="main-container">
    ...
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue">承运商基本信息</h3>
        ...
        <div id="base-info" class="tab-pane active dataTables_wrapper form-inline" role="grid">
            <div class="row">
                ...
                <div class="col-xs-3">
                    <div class="btn-group">
                        <a id="addItemNewPage" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>添加</a>
            ...
            <table id="sample-table" class="table table-striped table-bordered table-hover dataTable"
                ...
                <tr class="odd" style="display:none;">
                    ...
                    <td class="companyName"><input type="text"></td>
                    <td class="phoneNumber"><input type="text"></td>
                    <td class="corporation"><input type="text"></td>
                    <td class="introduction"><input type="text"></td>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/company/company.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/manage.js"></script>
<script type="text/javascript">
    $(document).ready(function () {
        $("#sample-table").on("click", "#editNewPage", function () {
            var tr = $(this).parent().parent().parent();  //改动html标签嵌套时，注意选择到tr
            var url = contextPath + "/company/" + $(".id", tr).text() + "?edit";
            self.location.href = url;
        });
        $("#sample-table").on("click", "#detail", function () {
            var tr = $(this).parent().parent().parent();  //改动html标签嵌套时，注意选择到tr
            var url = contextPath + "/company/" + $(".id", tr).text();
            self.location.href = url;
        });
        $("#addItemNewPage").click(function () {
            location.href = contextPath + "/view/company/companyAdd.jsp";
        });
    });
</script>
</body>
