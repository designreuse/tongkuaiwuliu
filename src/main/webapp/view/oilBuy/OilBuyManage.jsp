...
<div class="main-container" id="main-container">
  ...
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">燃油记录</h3>
    ...
    <div id="base-info" class="tab-pane active dataTables_wrapper form-inline" role="grid">
      <div class="row">
        ...
        <div class="col-xs-3">
          <div class="btn-group">
            ...
            <a id="deleteItem" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>删除</a>
      ...
      <table id="sample-table" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info" >
        ...
        <tr class="odd" style="display:none;">
          ...
          <td class="staffId"   style="display: none"></td>
          <td class="vehicle"><select class="vehicleSelect"></select></td>
          <td class="staff"><select class="staffSelect"></select></td>
          <td class="litre"><input type="text"></td>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/oilBuy/OilBuy.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/oilBuy/oilBuyManage.js"></script>
</body>
