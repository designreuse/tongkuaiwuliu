...
<div class="main-container" id="main-container">
  ...
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">运输任务信息</h3>
    ...
    <div id="base-info" class="tab-pane active dataTables_wrapper form-inline" role="grid">
      ...
      <table id="sample-table" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info" >
        ...
        <tr class="odd" style="display:none;">
          ...
          <td class="uid" style="display: none;"></td>

          <td class="title"><input type="text"></td>
          <td class="startDate"><input type="text"></td>
          <td class="endDate"><input type="text"></td>
          <td class="state"><input type="text"></td>
          <td class="type"><input type="text"></td>
          <td class="rate"><input type="text"></td>
          <td class="sumPrice"><input type="text"></td>
          <td class="op">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/transTask/transTask.js"></script>
...
<script type="text/javascript">
  $(document).ready(function () {
    $("#sample-table").on("click","#editItemNewPage", function () {
      ...
      var url = "editTransTask.jsp?sid="+$(".id",tr).text()+"&uid="+$(".uid",tr).text();
      self.location.href=url;
    });
    $("#sample-table").on("click","#detail", function () {
      var tr=$(this).parent().parent().parent();  //改动html标签嵌套时，注意选择到tr
      var url = "detailTransTask.jsp?sid="+$(".id",tr).text()+"&uid="+$(".uid",tr).text();
      self.location.href=url;
    });
  });
</script>
